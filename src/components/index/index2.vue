...
export default {
  ...
  methods: {
    ...
    mouseup1(e){
      ...
      if(this.lineData.length!=0){
        this.lineData[1] = {x:getOffsetX(e),y:getOffsetY(e)}
        localStorage.setItem('codeArr3'+this.code,JSON.stringify(this.lineData));
        this.markLine = {
          symbol:'none',
          lineStyle: {
              normal: {
        ...
        let codeArr3 = localStorage.getItem('codeArr3')?JSON.parse(localStorage.getItem('codeArr3')):[];
        codeArr3.unshift(this.msg);
        localStorage.setItem('codeArr3',JSON.stringify(codeArr3));
      }
    },
    filterVal(val) {
      if (val == this.idx) {
    ...
    setIdx(code,msg) {
      ...
      this.msg = msg;
      this.bole = true;
      this.lineData = localStorage.getItem('codeArr3'+code)?JSON.parse(localStorage.getItem('codeArr3'+code)):[];
      this.markLine = {
        symbol:'none',
          lineStyle: {
              normal: {
