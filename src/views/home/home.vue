  ...
  inactive-color="#ff4949">
    ...
    <el-menu
      ...
      <el-menu-item index="1">
        <span slot="title"><router-link to="/content" class="link"><span :class="{'active':$route.name}">首页</span></router-link></span>
      </el-menu-item>
      <!-- <el-menu-item index="2">
        <span slot="title"><router-link to="/index1" class="link"><span :class="{'active':$route.name=='index1'}">历史记录</span></router-link></span>
      </el-menu-item> -->
    </el-menu>
    <router-view class="contentView" ref='routes'/>
    ...
    <el-table-column prop="address" align= 'center' label="操作">
      <template slot-scope="scope">
        <el-button
          size="mini"
          type="primary"
          @click="addData( scope.row.code,scope.row.name,scope.$index)">添加</el-button>
    </template>
    </el-table-column>
  </el-table>
</el-dialog>
