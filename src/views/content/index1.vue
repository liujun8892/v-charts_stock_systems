...
import tpl from '@/components/index/index1'
  ...
  created(){
    ...
    methods:{
        setRemark(index,scope){
          let list = localStorage.getItem('codeArr1') ? JSON.parse(localStorage.getItem('codeArr1')):[];
          list[index].dateRemark = scope.dateRemark;
          localStorage.setItem('codeArr1',JSON.stringify(list));
        ...
        handleDelete(index,scope){
            this.$confirm('是否删除此条股票?', '提示', {
                ...
                let arr = JSON.parse(localStorage.getItem('codeArr1'));
                let idx = -1;
                ...
                localStorage.setItem('codeArr1',JSON.stringify(arr))
            this.$message({
                type: 'success',
                message: '删除成功!'
            });
        ...
        async getList(){
            ...
            this.list = localStorage.getItem('codeArr1') ? JSON.parse(localStorage.getItem('codeArr1')):[];
